...
var shim = require('../ios-drag-drop.js');
shim(document, { enableEnterLeave: true });
// For discussion and comments, see: http://remysharp.com/2009/01/07/html5-enabling-script/
/*@cc_on'abbr article aside audio canvas details figcaption figure footer header hgroup mark menu meter nav output progress section summary time video'.replace(/\w+/g,function(n){document.createElement(n)})@*/

var addEvent = window.addEvent = (function () {
...
},{"../ios-drag-drop.js":2}],2:[function(require,module,exports){
var module = (typeof module === 'object' && typeof module.exports === 'object') ? module : {};
function _exposeIosHtml5DragDropShim(doc, config) {
  ...
  function main() {
    config = config || {};
    console.log('begin run with config', config);
...
if (typeof module === 'object' && typeof module.exports === 'object') {
  ...
  _exposeIosHtml5DragDropShim(document, window.iosDragDropShim);
}
